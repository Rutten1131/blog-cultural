...
export const UI_TRANSLATIONS: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "evento.patrocinadores": "Este evento ha sido posible gracias a:",
  ...
  en: {
    ...
    "evento.patrocinadores": "This event was made possible thanks to:",
  ...
  fr: {
    ...
    "evento.patrocinadores": "Cet événement a été rendu possible grâce à :",
  ...
  de: {
    ...
    "evento.patrocinadores": "Dieses Event wurde ermöglicht durch:",
  ...
  pt: {
    ...
    "evento.sobre_este_evento": "Sobre este evento",
    "evento.patrocinadores": "Este evento foi possível graças a:",
